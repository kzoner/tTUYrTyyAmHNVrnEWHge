<%@ Page Title="" Language="C#" MasterPageFile="~/ContentPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebAdmin.Function.Order.Edit.Default" %>
            ...
            <td valign="top">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnAdd" runat="server" Text="Thêm" OnClick="btnAdd_Click" CommandName="Add" />
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="gvData" runat="server" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lblEdit" runat="server" Text="Sửa" OnClick="lbtnEdit_Clicked"
