<%@ Page Title="" Language="C#" MasterPageFile="~/ContentPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebAdmin.Function.Account.Edit.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterPlaceHolder" runat="server">
    <table class="box">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlAccountLevel" runat="server" Width="405px">
                </asp:DropDownList>
            </td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlAccountStatus" runat="server" Width="405px">
                </asp:DropDownList>
            </td>
            <td></td>
        </tr>
