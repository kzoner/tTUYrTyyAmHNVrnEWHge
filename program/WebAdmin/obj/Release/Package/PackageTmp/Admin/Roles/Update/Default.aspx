<%@ Page Title="" Language="C#" MasterPageFile="~/ContentPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebAdmin.Admin.Roles.Update.Default" %>
...
<tr><td></td><td>
    <asp:Button ID="btnUpdate" runat="server" Text="Lưu" Width="80px" onclick="btnUpdate_Click" 
         />
    </td><td>
        &nbsp;</td></tr>
</table>
